...
# as list
models_in = ['XGBoost'] # ['strd_regr', 'strd_mlr']
...
if part_in == 'train': part_name = 'training'
if part_in == 'valnit': part_name = 'testing'
plt.suptitle(f'{metric_in} for {part_name} using {models_in}')

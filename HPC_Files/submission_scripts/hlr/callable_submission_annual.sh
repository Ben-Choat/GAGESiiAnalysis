...
# name of folder to create and work in
WORK_WORK="${SCRATCH_DIR}/${TIME_LBL}/${CLST_MTH}/${CLST_LBL}"
...
# if work_work already exists, delete it, and remake it to work with fresh env.
rm -r $WORK_WORK
